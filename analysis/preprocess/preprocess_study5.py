...
RAW_DIR = "../../data/study-5/raw"
OUTPUT_DIR = "../../data/study-5/non_anonymized"

# Ensure output directory exists
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Define output file paths
data_csv_path = os.path.join(OUTPUT_DIR, "study-5_data.csv")
exit_survey_csv_path = os.path.join(OUTPUT_DIR, "study-5_demographics.csv")
bonus_csv_path = os.path.join(OUTPUT_DIR, "study-5_bonuses.csv")
