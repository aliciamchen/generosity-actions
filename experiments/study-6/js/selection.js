    ...
    const selectionInstructions = {
      ...
      stimulus: `
        ...
        <div class="align-left">
          ...
          <p>Your goal is to collect as many points as possible. You will see your total score at the end of the study.</p>
  ...
  const selectionTrial = {
    ...
    on_finish: function (data) {
      ...
      if (!pairedInteraction.isAttentionCheck) {
        ...
        data.points = data.coordination ? 
          (data.partner_choice === "give" ? 2 : 1) : 
          0;
      } else {
      ...
      stimulus: function () {
        ...
        return `
          ...
          partnerChoice === "give"
            ...
            <p>You earned <strong>${lastTrialData.points}</strong> points.</p>
          </div>
        `;
      },
      choices: ["Continue"],
